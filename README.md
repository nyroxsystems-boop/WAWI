...
* WWS/Bot/Dashboard Backend additions: see `docs/local_dev.md` (Setup, ENV, docker-compose) and `docs/bot_api_contract.md` (Bot client contract). Deployment checklist: `docs/DEPLOYMENT.md`.
